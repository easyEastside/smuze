...
Route::middleware('auth')->prefix('servers/{server}/services')->name('server.services.')->group(function (): void {
    ...
    Route::post('{service}/install/stream', [ServicesController::class, 'installStream'])->whereIn('service', ['php', 'apache', 'mysql', 'node', 'nvm', 'npm', 'composer'])->name('install.stream');
    ...
    Route::post('{service}/deinstall/stream', [ServicesController::class, 'deinstallStream'])->whereIn('service', ['php', 'apache', 'mysql', 'node', 'nvm', 'npm', 'composer'])->name('deinstall.stream');
});
